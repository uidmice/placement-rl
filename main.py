...
class PlacementEnv:
    def __init__(self, n_devices, n_types, edge_list, seed=0):

        self.network = StarNetwork(n_devices, n_types)
        self.program = Program(edge_list, self.network)
        ...
        self.done = False
        self.max_steps = 30 * self.n_operators
        self.step_count = 0
...
N = 50
k = 5
edge_list = [(0, 1), (0, 2), (0, 3), (1, 4), (1, 6), (2, 4), (2, 3), (3, 5), (4, 5), (5, 6)]


env = PlacementEnv(N, k, edge_list)
